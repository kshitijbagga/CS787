...
class TRGAN(nn.Module):
    ...
    def __init__(self):
        ...
        with open('util/models/model.py', 'rb') as f:
        ...
        for idx in range(len(fake_lab)):
            ...
            for i in STdict.keys():
                ...
                if STdict[i]['ischar']:
                    ...
                    viz_pats.append(addWeighted(STdict[i]['patch'], 0.5, np.ones_like(STdict[i]['patch'])*STdict[i]['decoder_attention_score'][idx], 0.5, 0))
            ...
            for i in range(len(fake_lab)):
                    ...
                    #FAKEdict[i]['patch'] = addWeighted(FAKEdict[i]['patch'] , 0.5, np.ones_like(FAKEdict[i]['patch'] ), 0.5, 0)
                ...
                putText(img, text, (textX, textY ), font, 1, (255, 255, 255), 2)
